...
export class EventComponent implements OnInit {
  ...
  folderPath: string = ''; // Declare folderPath

  // Define eventForm with folder_path control
  eventForm: FormGroup = this.fb.group({
    event_list_comments: [''],
    total_repetitions: [],
    folder_path: [''] // Add folder_path control
  });
  ...
  <form [formGroup]="eventForm">
    <div class="event-list-column">
      ...
      <div class="comments-row">
        ...
        <div *ngIf="eventForm.value.folder_path">
          <p><strong>Folder Path:</strong> {{ eventForm.value.folder_path }}</p>
        </div>
      </div>
    </div>
  </form>
